...
public class BusRoute extends AsyncTask<Object, String, String> {
    String queryResult;
    GoogleMap mMap;
    String preUrl = "http://truetime.portauthority.org/bustime/api/v3/getpatterns?key=DNtdvbsiqryXXzC5cvCeSntuX&rtpidatafeed=Port%20Authority%20Bus&format=json&rt=";
    String url;
